...
let numberOfDroids = prompt("количество дроидов купить?");
...
if(totalPrice>credits) {
    ...
    difference=credits-totalPrice;
}
alert("Вы купили "+numberOfDroids+"дроидов, на счету осталось "+difference+"кредитов.")
